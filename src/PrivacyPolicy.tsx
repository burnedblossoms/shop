...
export default function PrivacyPolicy() {
  return (
    <React.Fragment>
      <h1>Privacy Policy of Burned Blossoms</h1>

      <p>
        Burned Blossoms operates the https://burnedblossoms.github.io/shop
      ...
      <p>
        ...
        decided to use our Service, the burnedblossoms website.
      </p>
      ...
      <p>
        ...
        https://burnedblossoms.github.io/shop, unless otherwise defined in this
        Privacy Policy.
      </p>
